...
{% block javascript %}
    ...
    require(["gitbook", "jquery"], function(gitbook, $) {
        ...
        function buildPageOutline() {
            ...
            let html = '<div class="outline-title">On this page</div><ul class="outline-list">';
            ...
            <div class="body-inner">
                {% block book_inner %}
                    ...
                    <div class="page-wrapper" tabindex="-1" role="main" style="display: flex; gap: 24px;">
                        ...
                        <!-- ========================================================================= -->
                        <!-- DI SINI PERUBAHANNYA: Placeholder untuk Outline "On this page" -->
                        <!-- ========================================================================= -->
                        <div id="page-outline"></div>

                    </div>

                     <!-- Search Modal (Hanya satu yang disimpan untuk menghindari duplikasi) -->
